package com.tencent.iot.hub.device.android.app.remotecontrol;
...
public class ScalableImageView extends androidx.appcompat.widget.AppCompatImageView{
    ...
    private List<Float> angleList = new ArrayList<>();//For story the angle data
    private int circle ;
